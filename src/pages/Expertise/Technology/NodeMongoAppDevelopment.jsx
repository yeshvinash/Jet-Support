...
import Nextjs from "../../../assets/images/technology/icons/nextjs.svg";
import Redux from "../../../assets/images/technology/icons/redux.svg";
import NodeJS from "../../../assets/images/technology/icons/nodejs.svg";
import MongoDB from "../../../assets/images/technology/icons/mongodb.svg";
import VueJS from "../../../assets/images/technology/icons/vuejs.svg";
import NestJSOne from "../../../assets/images/technology/icons/nestjs-one.svg";
import AWSServices from "../../../assets/images/technology/icons/aws-services.svg";
import ObjectiveC from "../../../assets/images/technology/icons/objective-C.svg";
import DynamoDB from "../../../assets/images/technology/icons/dynamodb.svg";
import Xmpp from "../../../assets/images/technology/icons/xmpp.svg";
import Sass from "../../../assets/images/technology/icons/sass.svg";
import NestJSTwo from "../../../assets/images/technology/icons/nestjs-two.svg";
import Docker from "../../../assets/images/technology/icons/docker.svg";
import Express from "../../../assets/images/technology/icons/express.svg";
import NodeMongoAppDev from "../../../assets/images/technology/node-mongo-app-development.png";
...
export const NodeMongoAppDevelopement = () => {
  return (
    <>
          ...
          <Container>
            <div className="banner-content md spacing-top-md spacing-bottom-md text-center">
              <h2 className="ice mb-6">
                <span className="gradient-text">Node.js And Mongodb</span>for
                Web App Development
              </h2>
            ...
            <div className="d-flex expertise-flex expertise-flex-3">
              <div className="expertise-content-wrapper">
                <div className="expertise-content">
                  <h4 className="small mb-2 fw-medium">Web App Development</h4>
                  <p className="fw-normal mb-5 expertise-description">
                    Build Progressive Web Apps that combine the best technical
                    solutions applied in mobile and web applications beneficial
                    in terms of the ease of development and distribution, as
                    well as a number of other advantages for your business. Talk
                    to our experts to discuss:
                  </p>
              ...
              <div className="expertise-logo-main-wrapper">
                <div className="expertise-logo-wrapper">
                  ...
                  <div className="expertise-logo">
                    ...
                    <div className="p mb-0 text-center">Nextjs</div>
                  </div>
                  <div className="expertise-logo">
                    <div className="mb-2">
                      <img
                  ...
                  <div className="expertise-logo">
                    ...
                    <div className="p mb-0 text-center">NodeJS</div>
                  </div>
                  <div className="expertise-logo">
                    <div className="mb-2">
                      <img
                  ...
                  <div className="expertise-logo">
                    ...
                    <div className="p mb-0 text-center">VueJS</div>
                  </div>
                  <div className="expertise-logo">
                    <div className="mb-2">
                      <img
                    ...
                    <div className="p mb-0 text-center">NestJS</div>
                  </div>
                  <div className="expertise-logo">
                    <div className="mb-2">
                      <img
                    ...
                    <div className="p mb-0 text-center">AWS Services</div>
                  </div>
                  <div className="expertise-logo">
                    <div className="mb-2">
                      <img
                  ...
                  <div className="expertise-logo">
                    ...
                    <div className="p mb-0 text-center">DynamoDB</div>
                  </div>
                  <div className="expertise-logo">
                    <div className="mb-2">
                      <img src={Xmpp} className="d-block text-center mx-auto" />
                    </div>
                    <div className="p mb-0 text-center">XMPP</div>
                  </div>
                  <div className="expertise-logo">
                    <div className="mb-2">
                  ...
                  <div className="expertise-logo">
                    ...
                    <div className="p mb-0 text-center">NestJSTwo</div>
                  </div>
                  <div className="expertise-logo">
                    <div className="mb-2">
                      <img
                    ...
                    <div className="p mb-0 text-center">Docker</div>
                  </div>
                  <div className="expertise-logo">
                    <div className="mb-2">
                      <img
                    ...
                    <div className="p mb-0 text-center">Express</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Row>
            ...
            <Col xl={2}>
              <div className="process-ils">
                <Image src={NodeMongoAppDev} alt="ios-app-process" fluid />
              </div>
            </Col>
            <Col xl={10}>
        ...
        <section className="ios-app-help-wrap">
          <Container>
            <div className="section-title text-center">
              <h2 className="white mb-3 text-capitalize">How can we help with your Web app?</h2>
      ...
      <section className="bg-indigo spacing-top-lg spacing-bottom-lg">
        ...
        <section>
          <h2 className="mb-5 pb-5 white text-center text-capitalize">
            Our Web App Development clients
          </h2>
          <ImageSlider />
        </section>
      </section>
